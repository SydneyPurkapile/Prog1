...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._button2.Location = System.Drawing.Point(167, 310)
		...
		self._button3.Location = System.Drawing.Point(324, 310)
		...
		self._listBox1.Size = System.Drawing.Size(412, 292)
		self._listBox1.TabIndex = 3
		# 
		# MainForm
		# 
		self.BackColor = System.Drawing.SystemColors.ControlLight
		self.ClientSize = System.Drawing.Size(436, 351)
	...
	def Button1Click(self, sender, e):
		for num in range(1, 20):
			...
			third = num * 4
			forth = first ** 2
			msg = str(first) + "\t" + str(second) + "\t" + str(third) + "\t" + str(forth)
