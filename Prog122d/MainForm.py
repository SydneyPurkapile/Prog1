...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._button2.Location = System.Drawing.Point(154, 334)
		...
		self._button3.Location = System.Drawing.Point(298, 334)
		...
		self._listBox1.Size = System.Drawing.Size(387, 316)
		self._listBox1.TabIndex = 3
		# 
		# MainForm
		# 
		self.BackColor = System.Drawing.SystemColors.ControlLight
		self.ClientSize = System.Drawing.Size(411, 375)
	...
	def Button1Click(self, sender, e):
		...
		for num in range(-12, 16+1):
			wow = num**6 - (3 * num**5) - (93 * num**4) + (87 * num**3) + (1596 * num**2) - (1380 * num) - 2800
			msg = str(num) + "\t\t" + str(wow)
