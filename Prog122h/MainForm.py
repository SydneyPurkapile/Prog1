...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._button1.Location = System.Drawing.Point(578, 12)
		...
		self._button2.Location = System.Drawing.Point(578, 71)
		...
		self._button3.Location = System.Drawing.Point(578, 130)
		...
		self._listBox1.Size = System.Drawing.Size(560, 148)
		self._listBox1.TabIndex = 3
		# 
		# MainForm
		# 
		self.BackColor = System.Drawing.SystemColors.ControlLight
		self.ClientSize = System.Drawing.Size(684, 175)
	...
	def Button1Click(self, sender, e):
		heading = "Num\tSquare\tSqrt\tCube\t4th Root"
		...
		for num in range(1,21):
			...
			rt = num**.25
			rt = round(rt, 4)
			msg = str(Num) + "\t" + str(Sqr) + "\t" + str(sqrt) + "\t" + str(Cube) + "\t" + str(rt)
